...
Closed. Flag-based inline plan interface shipped in v0.2.0. All 9 scenarios green. Documentation updated (skill docs, README, usage text, env var parameterization with proper quoting).
